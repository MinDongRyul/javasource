...
public class SubscriberInfoEx2 {
	public static void main(String[] args) {
		...
		SubscriberInfo info[] = new SubscriberInfo[3]; // 3 => 3개의 배열 생성 [주소, 주소, 주소]
		// 생성된 배열에 SubscriberInfo 객체를 생성 후 담기
	...
	static void print(SubscriberInfo info[]){ // 위에 info 아래 info 둘다 똑같은 곳을 가르킨다 
		//for(타입 변수명:배열명)
		for (SubscriberInfo s:info) { // info로부터 주소를 가져옴
